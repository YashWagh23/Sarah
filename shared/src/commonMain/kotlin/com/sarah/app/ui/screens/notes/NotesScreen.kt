...
fun NotesScreenContent(
    ...
    onOpenAddSheet: (AcademicNote?) -> Unit,
    onCloseAddSheet: () -> Unit,
    onSaveNote: (title: String, content: String, subjectId: Long?, isPinned: Boolean) -> Unit,
    onTogglePin: (AcademicNote, Boolean) -> Unit,
    onConvertToTask: (AcademicNote) -> Unit,
    onOpenReminderConversion: (AcademicNote) -> Unit,
    onCloseReminderConversion: () -> Unit,
    onSaveReminderFromNote: (note: AcademicNote, title: String, message: String, timeEpochMs: Long) -> Unit,
                    ...
                    LazyColumn(
                        ...
                        if (uiState.pinnedNotes.isNotEmpty()) {
                            ...
                            items(uiState.pinnedNotes, key = { "pinned_${it.id}" }) { note ->
                                AcademicNoteCard(
                                    note = note,
                                    onTogglePin = { isPinned -> onTogglePin(note, isPinned) },
                                    onEdit = { onOpenAddSheet(note) },
                                    onConvertToTask = { onConvertToTask(note) },
                                    onConvertToReminder = { onOpenReminderConversion(note) },
    ...
    uiState.reminderConversionNote?.let { note ->
        AddCustomReminderSheet(
            ...
            onDismiss = onCloseReminderConversion,
